    ...
    <div class="nav-cards-row">
        ...
        <div class="nav-card-wrapper">
            <div class="nav-card">
                ...
                <a href="<?php echo e(route('doctors.menu')); ?>">Manage Appointments</a>
            </div>
        </div>
        <div class="nav-card-wrapper">
            <div class="nav-card">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Z:\Laravel 8\rumah_sakit_advent\resources\views/doctor/dashboard.blade.php ENDPATH**/ ?>