...
<div class="admission-container">
    ...
    <form action="{{ route('admissions.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="date" name="admission_date" id="admission_date" class="form-control" value="{{ old('admission_date', today()->toDateString()) }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="room_id" id="room_id" class="form-control" required>
                ...
                @foreach ($rooms as $room)
                    <option value="{{ $room->id }}" {{ $admissionModel->isRoomOccupied($room->id) ? 'disabled' : '' }} {{ old('room_id') == $room->id ? 'selected' : '' }}>
                        {{ $room->name }} {{ $admissionModel->isRoomOccupied($room->id) ? '(Occupied)' : '' }}
                    </option>
                @endforeach
            </select>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        admissionDateInput.addEventListener('change', function () {
            ...
            fetch(`{{ route('admissions.getAvailableRooms') }}?admission_date=${selectedDate}`, {
                headers: {
