...
<body>
    ...
    <div id="app">
        <nav id="left-menu">
            <ul>
                <li>
                    <a href="{{ route('admissions.index') }}" class="{{ Route::is('admissions.*') ? 'active' : '' }}">
                        <i class="fas fa-hospital"></i> Admissions
                    </a>
                </li>
                <li>
                    <a href="{{ route('medical_records.indexInpatient') }}" class="{{ Route::is('medical_records.indexInpatient') ? 'active' : '' }}">
                        <i class="fas fa-folder-open"></i> Medical Records
                    </a>
                </li>
                <li>
                    <a href="{{ route('inpatient.patients.index') }}" class="{{ Route::is('inpatient.patients.*') ? 'active' : '' }}">
                        <i class="fas fa-users"></i> Patients
                    </a>
                </li>
                <li>
                    <a href="{{ route('billing.index') }}" class="{{ Route::is('billing.*') ? 'active' : '' }}">
