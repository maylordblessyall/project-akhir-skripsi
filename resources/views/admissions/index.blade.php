...
<div class="admission-dashboard">
    ...
    <a href="{{ route('admissions.create') }}" class="btn btn-primary mb-3">Daftar Pasien Baru</a>
    ...
    <div class="room-grid">
        @foreach ($rooms as $room)
            ...
            @endphp
            <div class="room-box {{ $admission ? 'occupied' : 'vacant' }}">
                <h5>{{ $room->name }}</h5>
                <p>
                    @if ($admission)
                ...
                @if ($admission)
                    <div class="actions">
                        <a href="{{ route('medical_records.createForInpatient', ['admission' => $admission->id]) }}" class="btn btn-success btn-sm">Add Medical Record</a>
                        <a href="{{ route('admissions.edit', $admission->id) }}" class="btn btn-primary btn-sm">Update</a>
