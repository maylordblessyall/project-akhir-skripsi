        ...
        <nav id="left-menu">
            <ul class="main-menu">
                <?php
                    ...
                    $isRegistrationStaff = $user?->isRegistrationStaff() ?? false;
                    $isNurse = $user?->isNurse() ?? false;
                ?>
            
                <?php if (! ($isDoctor)): ?>
                    <li>
                        <a href="<?php echo e(route('manager.dashboard')); ?>" class="<?php echo e(Route::is('manager.dashboard') ? 'active' : ''); ?>">
                ...
                <?php if (! ($isNurse)): ?>    
                    <li>
                        <a href="<?php echo e(route('appointments.index')); ?>" class="<?php echo e(Route::is('appointments.*') ? 'active' : ''); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('patients.index')); ?>" class="<?php echo e(Route::is('patients.*') ? 'active' : ''); ?>">
                        <i class="fas fa-users"></i> Patients
                    </a>
                </li>
            
                <?php if (! ($isAdmin || $isNurse ||$isRegistrationStaff)): ?>
                    <li>
                        <a href="<?php echo e(route('doctors.menu')); ?>" class="<?php echo e(Route::is('doctors.menu') ? 'active' : ''); ?>">
                            <i class="fas fa-user-md"></i> Doctor's Actions
                        </a>
                    </li>
                <?php endif; ?>
            
                <li>
                    <a href="<?php echo e(route('medical_records.index')); ?>" class="<?php echo e(Route::is('medical_records.*') ? 'active' : ''); ?>">
                        <i class="fas fa-file-medical"></i> Medical Records
                    </a>
                </li>
            
                <?php if (! ($isDoctor || $isNurse ||$isRegistrationStaff)): ?>
                    <li class="staff-menu">
                        <a href="#" class="staff-link"><i class="fas fa-user-md"></i> Staff</a>
                        <ul class="sub-menu">
                            
                            <li>
                                <a href="<?php echo e(route('register')); ?>" class="<?php echo e(Route::is('register') ? 'active' : ''); ?>">
                                    <i class="fas fa-user-plus"></i> New Login User
                                </a>
                            </li>
                        </ul>
                    </li>
...
</html><?php /**PATH Z:\Laravel 8\rumah_sakit_advent\resources\views/layouts.blade.php ENDPATH**/ ?>