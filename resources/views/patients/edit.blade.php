...
@section('content')
    ...
    <div class="edit-patient-container">
        ...
        <div class="table-responsive">
            <form action="{{ route('patients.update', $patient->id) }}" method="POST" aria-labelledby="editPatientTitle">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <textarea name="alergi" id="alergi" class="form-control" rows="3">{{ old('alergi', $patient->alergi) }}</textarea>
                </div>

                <div class="form-group">
                    <label for="riwayat_medis">Riwayat Medis (Medical History):</label>
                    <textarea name="riwayat_medis" id="riwayat_medis" class="form-control" rows="3">{{ old('riwayat_medis', $patient->riwayat_medis) }}</textarea>
                </div>

                <div class="form-group">
                    <label for="obat_yang_dikonsumsi">Obat yang Dikonsumsi (Current Medications):</label>
                    <textarea name="obat_yang_dikonsumsi" id="obat_yang_dikonsumsi" class="form-control" rows="3">{{ old('obat_yang_dikonsumsi', $patient->obat_yang_dikonsumsi) }}</textarea>
                </div>
