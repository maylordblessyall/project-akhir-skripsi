    ...
    <div class="d-flex justify-content-between align-items-end mb-4">
        ...
        <form action="<?php echo e(route('appointments.index')); ?>" method="GET" class="d-flex align-items-end">
            <div class="form-group me-2">
                ...
                <input type="date" name="date_from" id="date_from" class="form-control" value="<?php echo e(request()->input('date_from')); ?>">
            </div>
            <div class="form-group me-2">
                <label for="date_to" class="form-label">To:</label>
                <input type="date" name="date_to" id="date_to" class="form-control" value="<?php echo e(request()->input('date_to')); ?>">
            </div>
    ...
    <div class="table-responsive">
        ...
        <?php else: ?>
            <div class="alert alert-info text-center" role="alert">
                No appointments found. Click <a href="<?php echo e(route('appointments.create')); ?>">here</a> to create one.
            </div>
        <?php endif; ?>
    </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Z:\Laravel 8\rumah_sakit_advent\resources\views/welcome.blade.php ENDPATH**/ ?>